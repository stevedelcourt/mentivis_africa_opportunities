...
def scrape_minesup_cameroon():
    ...
    try:
        ...
        if res.status_code != 200:
            print(f"MINESUP: Status {res.status_code}")
        ...
        print(f"MINESUP scraping error: {e}")

    return opportunities


if __name__ == "__main__":
    data = scrape_minesup_cameroon()
    print(f"Found {len(data)} opportunities from MINESUP")
