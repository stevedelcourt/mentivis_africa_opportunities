...
def scrape_globaltenders():
    ...
    try:
        ...
        if res.status_code != 200:
            print(f"GlobalTenders: Status {res.status_code}")
        ...
        if not items:
            ...
            for link in links:
                ...
                if href and not href.startswith("http"):
                    href = "https://www.globaltenders.com" + href
        ...
        print(f"GlobalTenders scraping error: {e}")

    return opportunities


if __name__ == "__main__":
    data = scrape_globaltenders()
    print(f"Found {len(data)} opportunities from GlobalTenders")
